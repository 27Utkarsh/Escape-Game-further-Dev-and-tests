...
public class Collision {
    ...
    public static boolean collisionCheck(Player player) {
        // checks 3 corners of the sprite to see if its colliding with a wall.
        // I originally checked 4 corners but it made movement around corners slightly smoother if I checked 3
        // The last check allows for the player to be walking in front of the wall were facing slightly
    ...
    /**
     * Checks whether there is a wall tile in the wallLayer at the players coordinates.
    ...
    private static boolean checkWall(Player player, float x, float y) {
        ...
        // checks the tile at position x,y if there is no tile there, return null
    ...
    /**
     * Checks whether there is a door tile in the doorLayer at the players coordinates.
